          ...
          >
            ...
            <div className="flex items-center">
              ...
              >
                ...
                <span className="font-bold text-lg bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent group-hover:from-purple-600 group-hover:to-indigo-600 transition-all duration-500">BeSocial</span>
              </div>
            ...
            <div className="flex items-center space-x-1 md:space-x-3">
              ...
              <a
                href={"https://github.com/pandeygopal"}
                target='_blank'
